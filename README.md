...
Хотя для модели `(50,), relu, lbfgs, 200` наблюдалось предупреждение о необходимости увеличения числа итераций, однако обучение завершилось с приемлемым результатом.
